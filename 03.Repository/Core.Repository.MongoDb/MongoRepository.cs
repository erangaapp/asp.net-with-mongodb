...
namespace Core.Repository.MongoDb
{
    ...
    public class MongoRepository<T> : IRepository<T> where T : CORE_ENT.IEntity
    {
        /// <summary>
        /// Mongo Database
        /// </summary>
        ...
        /// <exception cref="System.ArgumentException">Missing MongoDB connection string</exception>
        public MongoRepository(IMongoClient client, string connectionString)
        {
            if (connectionString == null)
            {
                throw new ArgumentException("Missing MongoDB connection string");
        ...
        public virtual async Task<T> Update(T entity)
        {
            ...
            {
                result = await this.Collection.ReplaceOneAsync(idFilter, entity, null);
        ...
        {
            return await this._collection.FindOneAndDeleteAsync(e => e.Id == id, null);
        }
